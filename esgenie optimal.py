...
.stButton > button[kind="primary"] {{
    background: linear-gradient(135deg, var(--sage), var(--forest)) !important;
    color: white !important;
    font-weight: 600 !important;
}}

/* ═════════════════════════════════════════════════════════════
   INPUTS (THIS FIXES YOUR BLACK BOXES)
═════════════════════════════════════════════════════════════ */
...
/* ═════════════════════════════════════════════════════════════
   EXPANDERS (01 — Financial Data etc.)
═════════════════════════════════════════════════════════════ */
...
with tab2:
    ...
    fig_f.add_trace(go.Scatter(
        ...
        marker=dict(color=esg_plot, colorscale="RdYlGn", cmin=0, cmax=100,
                    size=5, opacity=0.85,
                    colorbar=dict(
                        title=dict(text="ESG Score", font=dict(color="#2d5016")),
                        thickness=14,
