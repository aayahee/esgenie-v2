...
with tab1:
    ...
    <table style="width:100%;border-collapse:collapse;font-size:0.9rem;
      ...
      <tbody>
        ...
        <tr style="background:car(--soft-bg);">
...
with tab2:
    ...
    theme_text = "#0f2e1c" if not st.session_state.dark_mode else "#e5e7eb"
    fig_f = go.Figure()
    ...
    fig_f.update_layout(
        ...
        paper_bgcolor="#ffffff" if not st.session_state.dark_mode else "#0f1720",
        plot_bgcolor="#f9faf8" if not st.session_state.dark_mode else "#18212b",
        ...
        legend=dict(
            ...
            xanchor="left",
            x=0,
            font=dict(color=theme_text),  # ✅ THIS FIXES LEGEND
            bgcolor="rgba(255,255,255,0.85)" if not st.session_state.dark_mode else "rgba(24,33,43,0.85)",
            bordercolor="#c8dfc0",
            borderwidth=1
        ),
        ...
        xaxis=dict(
            ...
            tickfont=dict(color=theme_text),
            gridcolor="#e8f2e4" if not st.session_state.dark_mode else "#2a3441",
            zerolinecolor="#c8dfc0"
        ),
